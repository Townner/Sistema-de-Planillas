<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="ReporteTotalSalariosBrutos.aspx.cs" Inherits="UI.ReporteTotalSalariosBrutos" %>
...
<h4> Reporte de Total de Salarios Brutos</h4>
    ...
    <CR:CrystalReportViewer ID="Reporte_Total_Adelantos" runat="server" 
        ...
        ToolPanelWidth="100px" Width="716px" RenderingDPI="74" ToolPanelView="None" 
            ...
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="Reports\CRTotalSalariosBrutos.rpt">
                </Report>
