<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="ReporteLicencias.aspx.cs" Inherits="UI.ReporteLicencias" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContenidoPrincipalCentral" runat="server">
 ...
 <h4> Reporte de Vencimiento de Licencias </h4>
    ...
    <CR:CrystalReportViewer ID="Reporte_Total_Adelantos" runat="server" 
        ...
        ToolPanelWidth="100px" Width="716px" RenderingDPI="80" ToolPanelView="None" 
                HasRefreshButton="True" />
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="Reports\CRReporteLicencias.rpt">
                </Report>
