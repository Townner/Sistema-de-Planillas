<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="ReporteTotalRenta.aspx.cs" Inherits="UI.ReporteTotalRenta1" %>
...
<h4> Reporte de Total de Renta</h4>
    ...
    <CR:CrystalReportViewer ID="Reporte_Total_Adelantos" runat="server" 
        ...
        style="margin-top:30px;"
            ...
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="Reports\CRTotalRenta.rpt">
                </Report>
