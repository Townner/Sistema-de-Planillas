<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="ReporteTotalSalariosNetos.aspx.cs" Inherits="UI.ReporteTotalSalariosNetos" %>
...
<h4> Reporte de Total de Salarios Netos</h4>
    ...
    <CR:CrystalReportViewer ID="Reporte_Total_Adelantos" runat="server" 
        ...
        style="margin-top:30px;"
            ...
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="Reports\CRTotalSalariosNetos.rpt">
                </Report>
