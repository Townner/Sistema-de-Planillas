    ...
    <table style="width:100%; margin-top:20px; margin-top:10px;">
        ...
        <tr>
            <td class="style4">
                &nbsp;</td>
            <td class="style5">
            <h4 id ="lblModificar" runat="server" style="float:left; margin-left:8px;" > Inserte 
                su nueva contraseña</h4>
        ...
        <tr>
            ...
            <td class="style5">
                ...
                <asp:Button ID="btnUpdate" runat="server" Text="Modificar" 
                    onclick="btnDelete_Click" style="float:left; margin-left:120px; text-align: center; "/>
                </center>
            </td>
        </tr>
    </table>
