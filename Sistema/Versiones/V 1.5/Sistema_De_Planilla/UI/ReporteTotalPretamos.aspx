<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="ReporteTotalPretamos.aspx.cs" Inherits="UI.ReporteTotalRenta" %>
...
<h4> Reporte de Total de Prestamos</h4>
    ...
    <CR:CrystalReportViewer ID="Reporte_Total_Adelantos" runat="server" 
        ...
        style="margin-top:30px;"
            ...
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="Reports\CRTotalPrestamos.rpt">
                </Report>
