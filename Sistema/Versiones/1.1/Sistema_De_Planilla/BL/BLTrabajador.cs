...
namespace BL
{
    public class BLTrabajador
    {
        ...
        {
            TO.TOTrabajador tb = new TO.TOTrabajador();
            tb.Id = Id;
            tb.Nom = Nom;
            tb.Ap1 = Ap1;
            tb.Ap2 = Ap2;
        ...
        public void EliminarTrabajador(TO.TOTrabajador trab)
        {
            DA.DATrabajador eltb = new DA.DATrabajador();
            eltb.EliminarTrabajador(trab);
        }
        
        public TO.TOTrabajador ConsultarTrabajador(TO.TOTrabajador trab)
        {
