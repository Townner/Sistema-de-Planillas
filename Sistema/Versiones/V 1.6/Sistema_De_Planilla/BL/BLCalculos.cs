...
namespace BL
{
    public class BLCalculos
    {
        ...
        public void AgregarSalario()
        {
            ...
            TO_Calcu.Hijos_Menor = this.hijos_menor;
            TO_Calcu.Hijos_Mayor = this.hijos_mayor;
            TO_Calcu.Conyugue = this.conyugue;
            TO_Calcu.Ob_Pat_NoPen = this.ob_pat_nopen;
            TO_Calcu.Ob_Pat_Pen = this.ob_pat_pen;
            TO_Calcu.S_Cargas = this.s_cargas;
            TO_Calcu.S_Extras = this.s_extras;
            TO_Calcu.S_Incapacidad = this.s_incapcidad;
            TO_Calcu.S_Base = this.s_base;
            TO_Calcu.S_Bruto = this.s_bruto;
            TO_Calcu.S_Neto = this.s_neto;
            TO_Calcu.S_Final = this.s_final;

            DA.DACalculos afecha = new DA.DACalculos();
            afecha.AgregarSalario(TO_Calcu);
        }
        ...
        public void ModificarCalculos(BL.BLTrabajador BL_Trab)
        {
            ...
            DA.DACalculos ModCalculos = new DA.DACalculos();
