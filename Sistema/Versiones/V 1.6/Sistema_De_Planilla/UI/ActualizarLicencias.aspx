    ...
    <tr>
        ...
        <td class="style10">
            <asp:TextBox ID="txtCed" runat="server" style="float: left; margin-left:10px;" value="Cedula" onfocus="javascript:if(this.value == 'Cedula') this.value=''" 
                ...
                <asp:Button ID="btConsultarLic" runat="server" Text="Consultar" style="margin-left:50px; height: 26px;"
                    onclick="btConsultarLic_Click" />
                    <asp:Button ID="btnNew" runat="server" onclick="btnNew_Click" style="margin-left:10px;"
