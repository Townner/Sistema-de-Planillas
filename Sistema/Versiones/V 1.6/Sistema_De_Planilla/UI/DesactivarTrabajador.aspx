    ...
    <table style="width:100%; margin-top:20px; margin-top:10px;">
        <tr>
            ...
            <td class="style10">
                ...
                <asp:CheckBox ID="CBResidencia" runat="server" style="float:left; text-align: left; margin-left:20px;"
            ...
            <asp:RegularExpressionValidator ID="RegexCed" runat="server" style="color:Red; float: left; margin-left: 8px;"
                ...
                ValidationExpression="^\d{1}( |-)\d{4}( |-)\d{4}" ValidationGroup="Delete"></asp:RegularExpressionValidator>
            
                <br />
            <asp:RegularExpressionValidator ID="RegexCed0" runat="server" style="color:Red; float: left; margin-left: 8px;"
                ControlToValidate="txtCed" ErrorMessage="Formato Permitido: 111111111111" 
                ValidationExpression="^\d{2}\d{5}\d{5}" ValidationGroup="Delete"></asp:RegularExpressionValidator>
        ...
        <tr>
            <td class="style4">
                &nbsp;</td>
            <td class="style5">
                <asp:Button ID="btnDelete" runat="server" Text="Dar de Baja" 
                    onclick="btnDelete_Click" style="float:left; margin-left:280px;" 
                    Visible="False" ValidationGroup="Delete"/>
            </td>
            <td>
                &nbsp;</td>
        </tr>
