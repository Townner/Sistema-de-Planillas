...
namespace UI
{
    public partial class EliminarDepartamento : System.Web.UI.Page
    {
        ...
        protected void btnReg_Click(object sender, EventArgs e)
        {
            ...
            if (BL_Puest.EliminarDepartamento() != 1)
            {
                ...
                Response.Write("<script language='javascript'>alert('El departamento no se puede eliminar ya que hay trabajadores en el');document.location.href='" + "/EliminarPuesto.aspx" + "'; </script>");
            }
