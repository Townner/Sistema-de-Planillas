<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="EliminarDepartamento.aspx.cs" Inherits="UI.EliminarDepartamento" %>
...
<h4> Ingrese el nombre del departamento </h4>
    ...
    <tr>
        ...
        <td class="style4">
            ...
            <asp:RequiredFieldValidator ID="RFNombre" runat="server" 
                ControlToValidate="txtNombre" style=" margin-left:10px; float:left; color:Red;"
                ErrorMessage="Campo Obligatorio"></asp:RequiredFieldValidator>
            &nbsp;&nbsp;
            <asp:Button ID="btnConsultar" runat="server" Text="Consultar" style="float:left; margin-left:10px;"
                CommandName="Delete"
    ...
    <tr>
        <td class="style9">
                &nbsp;</td>
        <td class="style10">
            <asp:GridView ID="GrdDepartamento" runat="server" 
    ...
    <tr>
        ...
        <td class="style5">
                ...
                <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" 
                    ...
                    OnClientClick="return confirm('Esta seguro que desea eliminar este departamenot?');"
