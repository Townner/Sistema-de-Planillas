    ...
    public partial class EliminarPuesto : System.Web.UI.Page
    {
        ...
        protected void btnReg_Click(object sender, EventArgs e)
        {
            ...
            if (BL_Puest.EliminarPuesto() != 1)
            {
               ...
               Response.Write("<script language='javascript'>alert('El puesto fue eliminado correctamente');document.location.href='" + "/EliminarPuesto.aspx" + "'; </script>");
                ...
                Response.Write("<script language='javascript'>alert('El puesto no se puede eliminar ya que hay trabajadores en el');document.location.href='" + "/EliminarPuesto.aspx" + "'; </script>");
            }
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            if (CargarDatos().nom_puesto != null)
            {
                ...
                btnConsultar.Text = "Nueva Consulta";
            }
            else
            {
