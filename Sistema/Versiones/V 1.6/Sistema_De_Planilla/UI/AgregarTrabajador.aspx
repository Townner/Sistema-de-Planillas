...
<asp:Content ID="Content3" ContentPlaceHolderID="ContenidoPrincipalCentral" runat="server">
    ...
    <tr>
        ...
        <td class="style10">
            ...
            <br />
            <asp:RegularExpressionValidator ID="RegexCed0" runat="server" style="color:Red;"
        ...
        <td>
                <asp:CheckBox ID="CBResidencia" runat="server" style="float:left; text-align: left; margin-top:-30px"
