...
<h4 style="margin-top:10px;"> Modifique los datos del trabajador </h4>
    ...
    <tr>
        ...
        <td class="style7">
            <asp:TextBox ID="txtCed" runat="server" style="float: left; margin-left:22px;" value="Cedula" onfocus="javascript:if(this.value == 'Cedula') this.value=''" 
                ...
                <asp:CheckBox ID="CBResidencia" runat="server" style="float:right; text-align: left;"
            ...
            <asp:RegularExpressionValidator ID="RegexCed0" runat="server" style="color:Red; float:left; margin-left:10px;"
                ...
                ValidationExpression="^\d{2}\d{5}\d{5}" Width="251px"></asp:RegularExpressionValidator>
    ...
    <tr>
        ...
        <td class="style4">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico" runat="server" style=" color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtBase" ValidationGroup="Update"></asp:RegularExpressionValidator>
                <br />
        </td>
    </tr>
        <tr>
        ...
        <td class="style4">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico0" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtMPrestamo" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
        </tr>
    ...
    <tr>
        ...
        <td class="style8">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico1" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtCPrestamo" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        <td class="style7">
                Intereses:</td>
        <td class="style8">
                <asp:TextBox ID="txtIntereses" runat="server" style="margin-left:22px;"></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="REXPorcentaje" runat="server" style=" color: Red;"
                    ...
                    ControlToValidate="txtIntereses" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="style8">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico3" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtAhorros" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="style8">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico4" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtEmbargos" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="style8">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico5" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtAdelantos" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="style8">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico6" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtOtros" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="style8">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico7" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtMSubsidio" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="style8">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico8" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtAQuincenal" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="style8">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico9" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtAMensual1" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="style8">
                ...
                <asp:RegularExpressionValidator ID="REXNumerico10" runat="server" style="color: Red;"
                    ErrorMessage="Formato Correcto: 1111111,11" 
                    ValidationExpression="([0-9]{0,6}(?:,)?[0-9]{0,2})" 
                    ControlToValidate="txtAMensual2" ValidationGroup="Update"></asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
        <td class="style6">
    ...
    <tr>
        ...
        <td class="style7">
                <asp:Button ID="btnActua" runat="server" Text="Actualizar" 
                    ...
                    Visible="False" ValidationGroup="Update" onclick="btnActua_Click"  />
        </td>
    </tr>
    <tr>
        <td class="style6">
