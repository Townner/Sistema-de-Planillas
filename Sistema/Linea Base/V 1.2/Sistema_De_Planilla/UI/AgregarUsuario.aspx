    ...
    <tr>
        ...
        <td class="style10">
            ...
            &nbsp;<asp:RequiredFieldValidator ID="RFCed" runat="server" 
                ErrorMessage="Campo Obligatorio" ControlToValidate="txtID"></asp:RequiredFieldValidator>
&nbsp;
            <br />
&nbsp;<asp:RegularExpressionValidator ID="RegexCed" runat="server" 
    ...
    <tr>
        ...
        <td class="style10">
                ...
                &nbsp;<asp:RequiredFieldValidator ID="RFID" runat="server" 
                    ErrorMessage="Campo Obligatorio" ControlToValidate="txtID"></asp:RequiredFieldValidator>
&nbsp;
                <br />
&nbsp;<asp:RegularExpressionValidator ID="RegexID" runat="server" 
